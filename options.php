 ...
 *
 * If you are making your theme translatable, you should replace 'convomp'
...
// Standard Meta
	$options[] = array(
		'name' => __('Head ID', 'convomp'),
		'desc' => __("", 'convomp'),
		'id' => 'meta_headid',
		'std' => 'convomp',
		'type' => 'text');
	$options[] = array(
		'name' => __('Google Webmasters', 'convomp'),
		'desc' => __("Speaking of Google, don't forget to set your site up: <a href='http://google.com/webmasters' target='_blank'>http://google.com/webmasters</a>", 'convomp'),
		'id' => 'meta_google',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('Author Name', 'convomp'),
		'desc' => __('Populates meta author tag.', 'convomp'),
		'id' => 'meta_author',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('Mobile Viewport', 'convomp'),
		'desc' => __('Uncomment to use; use thoughtfully!', 'convomp'),
		'id' => 'meta_viewport',
...
// Icons
	$options[] = array(
		...
		'type' => 'upload');
	$options[] = array(
		'name' => __('Apple Touch Icon', 'convomp'),
		'desc' => __('', 'convomp'),
...
// App: Windows 8
	...
	$options[] = array(
		'name' => __('', 'convomp'),
		'desc' => __('Tile Color', 'convomp'),
		'id' => 'meta_app_win_color',
		'std' => '',
		'type' => 'color');
	$options[] = array(
		'name' => __('', 'convomp'),
		'desc' => __('Tile Image', 'convomp'),
...
// App: Twitter
	$options[] = array(
		'name' => __('App: Twitter Card', 'convomp'),
		'desc' => __('twitter:card (summary, photo, gallery, product, app, player)', 'convomp'),
		'id' => 'meta_app_twt_card',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'convomp'),
		'desc' => __('twitter:site (@username of website)', 'convomp'),
		'id' => 'meta_app_twt_site',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'convomp'),
		'desc' => __("twitter:title (the user's Twitter ID)", 'convomp'),
		'id' => 'meta_app_twt_title',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'convomp'),
		'desc' => __('twitter:description (maximum 200 characters)', 'convomp'),
		'id' => 'meta_app_twt_description',
		'std' => '',
		'type' => 'textarea');
	$options[] = array(
		'name' => __('', 'convomp'),
		'desc' => __('twitter:url (url for the content)', 'convomp'),
		'id' => 'meta_app_twt_url',
		'std' => '',
		'type' => 'text');
...
// App: Facebook
	$options[] = array(
		'name' => __('App: Facebook', 'convomp'),
		'desc' => __('og:title', 'convomp'),
		'id' => 'meta_app_fb_title',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'convomp'),
		'desc' => __('og:description', 'convomp'),
		'id' => 'meta_app_fb_description',
		'std' => '',
		'type' => 'textarea');
	$options[] = array(
		'name' => __('', 'convomp'),
		'desc' => __('og:url', 'convomp'),
		'id' => 'meta_app_fb_url',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'convomp'),
		'desc' => __('og:image', 'convomp'),
